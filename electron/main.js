...
function sanitizePageOcrResult(result) {
  ...
  return {
    ...
    confidence,
    imageWidth: Math.max(0, Number(result.imageWidth) || 0),
    imageHeight: Math.max(0, Number(result.imageHeight) || 0),
    pageRotation: ((Math.round((Number(result.pageRotation) || 0) / 90) * 90) % 360 + 360) % 360,
